"""
Docstring for poo.aula_156_docstrings.documentando_funcoes, Este é um módulo de exemplo
...
def soma(x: int | float, y: int | float) -> int | float:
    ...
    Este múdulo contém funções e exemplos de documentação de funções.
    A função soma você já conhece bem.
